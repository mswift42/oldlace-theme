...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-tooltip ((,class (:background ,bg1 :foreground ,fg1))))
   `(company-tooltop-annotation ((,class (:foreground ,const))))
   `(company-tooltip-common ((,class (:background ,bg3 :foreground ,fg2))))
   `(company-tooltip-common-selection ((,class (:background ,bg1 :foreground ,str))))
   `(company-tooltip-mouse ((,class (:inherit highlight))))
   `(company-tooltip-selection ((,class (:background ,fg3 :foreground ,bg1))))
